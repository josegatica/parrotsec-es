  ...
  '<footer id="footer">
    <div class="container-fluid">
        ...
        <div class="blue-triangular-division wow slideInDown"></div>
          <p class="text-center">© Lorenzo Faletra 2013-2017 Algunos Derechos Reservados | TeraBreik (Versión en español)</span> - <a target="_blank" href="https://www.gnu.org/licenses/gpl-3.0.en.html">GNU/GPL v3</a></p>
