        ...
        <div class="container">
            ...
            <div class="col-lg-3 col-md-3 col-md-offset-2 col-lg-offset-2 text-center">
              <div class="panel download panel-blue">
                ...
                <div class="panel-footer">
                  <a class="btn btn-lg btn-block btn-info" target="_blank" href="http://cdimage.parrotsec.org/parrot/iso/4.0.1/signed-hashes.txt">',$lang['download-full-11'],'</a>
    						</div>
    					</div>
            </div>
              ...
              <div class="panel download panel-blue">
                ...
                <ul class="list-group list-group-flush text-center">
                  ...
                  <li class="list-group-item"><i class="icon-ok text-info"></i>',$lang['download-full-8'],PARROT_FULL_SIZE_32,'</li>
    						...
    						<div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" href="http://cdimage.parrotsec.org/parrot/iso/4.0.1/Parrot-security-4.0.1_i386.iso">',$lang['index-3'],'</a>
    						</div>
                <div class="panel-footer">
                ...
                <div class="panel-footer">
    							<a class="btn btn-lg btn-block btn-info" href="http://cdimage.parrotsec.org/parrot/iso/4.0.1/Parrot-security-4.0.1_i386.iso.torrent">',$lang['download-full-10'],'</a>
    						</div>
                <div class="panel-footer">
                  <a class="btn btn-lg btn-block btn-info" target="_blank" href="http://cdimage.parrotsec.org/parrot/iso/4.0.1/signed-hashes.txt">',$lang['download-full-11'],'</a>
    						</div>
