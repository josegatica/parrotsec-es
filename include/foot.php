  ...
  '<footer id="footer">
    <div class="container-fluid">
        ...
        <div class="blue-triangular-division wow slideInDown"></div>
          <p class="text-center">© Lorenzo Faletra 2013-2018 Algunos Derechos Reservados | José Gatica (Versión en español)</span> - <a target="_blank" href="https://www.gnu.org/licenses/gpl-3.0.en.html">GNU/GPL v3</a></p>
